...
// TODO: Add tests for inheritance.

/// <summary>
/// Base class to inherit auto-generated NSwag clients from. Provides support for OpenAPI inheritance and partial POST/PATCH in JSON:API requests.
/// </summary>
public abstract class NewJsonApiClient
{
    ...
    /// <summary>
    /// Marks the specified properties on an object instance as tracked. This is useful when unable to use inline initializer syntax for tracking.
    /// </summary>
    /// <param name="container">
    /// The object instance that contains properties to track.
    /// </param>
    /// <param name="propertyNames">
    /// The names of the properties to track.
    /// </param>
    ...
    /// <summary>
    /// Replacement for the client-generated JsonInheritanceConverter that doesn't block other converters and preserves the JSON path on error.
    /// </summary>
    ...
    private sealed class PropertyTrackingWriteConverter : JsonConverter
    {
        ...
        // This is called BEFORE CanRead/CanWrite.
        public override bool CanConvert(Type objectType)
        {
        ...
        public override void WriteJson(JsonWriter writer, object? value, JsonSerializer serializer)
        {
            ...
            try
            {
                ...
                {
                    // We get here when the type is tracked, but not this instance.
                    serializer.Serialize(writer, value);
                }
            }
            finally
